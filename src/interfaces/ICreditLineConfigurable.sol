...
interface ICreditLineConfigurable {
    ...
    struct CreditLineConfig {
        //slot 1
        /// @notice The address of additional payments recipient
    ...
    struct BorrowerConfig {
        //slot 1
        /// @notice The expiration date of the configuration
        uint32 expiration;
        /// @notice The initial loan duration determined in periods
