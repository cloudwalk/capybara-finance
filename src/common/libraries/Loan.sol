...
library Loan {
    ...
    struct State {
        ...
        uint64 totalAmount;               // The initial total amount of the loan, including the addon.
        // Slot 2
        ...
        uint64 trackedPaymentBalance;     // The paiment balance of the loan that is tracked over its lifetime.
