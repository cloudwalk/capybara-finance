...
interface ILendingMarket {
    ...
    /// @param loanId The unique identifier of the loan.
    /// @param fromTimestamp The start timestamp of the moratorium period.
    /// @param moratoriumPeriods The number of periods of the moratorium.
    ...
    /// @notice Gets the lender of a credit line.
    ...
    /// @notice Gets the lender of a liquidity pool.
    ...
    /// @notice Checks if the provided account is an alias for a lender.
