...
interface ILiquidityPool {
    ...
    /// @notice A hook that is triggered by the associated market before the loan payment.
    ...
    /// @notice A hook that is triggered by the associated market after the loan payment.
    /// @param loanId The unique identifier of the loan being paid.
