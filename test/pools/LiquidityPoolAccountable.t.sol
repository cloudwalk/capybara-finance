...
contract LiquidityPoolAccountableTest is Test {
    ...
    function getLoanIds() public pure returns (uint256[] memory) {
    ...
    function getAmounts() public pure returns (uint256[] memory) {
    ...
    function getIncorrectLengthAmounts() public pure returns (uint256[] memory) {
    ...
    function test_deposit_Revert_IfCallerNotAdmin() public {
        ...
        liquidityPool.configureAdmin(ADMIN, true);
        uint256[] memory loans = getLoanIds();
        uint256[] memory amounts = getAmounts();
